...
@router.get("/", response_model=List[ResponseContact], dependencies=[Depends(RateLimiter(times=10, seconds=60))])
...
@router.get("/{contact_id}", response_model=ResponseContact, dependencies=[Depends(RateLimiter(times=10, seconds=60))])
...
@router.get("/search/", response_model=List[ResponseContact], dependencies=[Depends(RateLimiter(times=10, seconds=60))])
...
@router.put("/{contact_id}", response_model=ResponseContact, dependencies=[Depends(RateLimiter(times=10, seconds=60))])
